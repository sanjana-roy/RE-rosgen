...
DpthBf_Max <- 1.4275 # Insert the maximum bankfull depth from your point/reach of interest here, replacing the 8 left of the hash #
...
ggplot(CrossProf) +
       ...
       xlim(150,350) + # Sets the x-axis limits. Adjust this value as you zoom in to the correct area.
       ylim(1440,1470) + # Sets the y-axis limits. Adjust this value as you zoom in to the correct area.
       scale_color_gradient(low = "green", high = "brown") +
